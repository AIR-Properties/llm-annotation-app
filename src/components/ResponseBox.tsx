...
const ResponseBox: React.FC<ResponseBoxProps> = ({
  ...
  const handleFeedback = useCallback(async (newFeedback: 'helpful' | 'not_helpful') => {
    try {
  ...
  return (
    <div className="response-box">
      ...
      <div className="response-box-buttons">
        <button
          className={`response-box-button helpful ${feedback === 'helpful' ? 'selected' : ''}`}
        ...
        <button
          className={`response-box-button not-helpful ${feedback === 'not_helpful' ? 'selected' : ''}`}
