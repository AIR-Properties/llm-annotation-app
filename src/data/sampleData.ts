...
export const SAMPLE_ANNOTATIONS = {
  ...
  data: [
    {
      id: 'prompt_1',
      prompt: 'What are the key features and amenities of this property that make it stand out in the luxury real estate market? Please provide a detailed analysis of its unique selling points and how they compare to similar properties in the area.',
      responses: [
        { 
          id: 'response_1_1',
    ...
    {
      id: 'prompt_2',
      prompt: 'Can you describe the neighborhood and surrounding area of this property, including nearby amenities, schools, and transportation options? Please provide specific details about the community and its appeal to potential buyers.',
      responses: [
        { 
          id: 'response_2_1',
